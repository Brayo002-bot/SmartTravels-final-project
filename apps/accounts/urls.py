...
urlpatterns = [
    ...
    path('bookings/cancel/', views.passenger_cancel_booking, name='passenger_cancel_booking'),
    path('bookings/reschedule/', views.passenger_reschedule_booking, name='passenger_reschedule_booking'),
